...
FLEXIMART’s Data Warehouse has been designed by using a star-based schema to support efficient analytical reporting and historical sales analysis. The schema used consists of one central fact table connected to multiple dimension tables.
