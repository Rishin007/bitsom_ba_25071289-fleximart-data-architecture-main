...
conn.commit()
print("Old data has been removed from the tables..... ")


customers = pd.read_csv("C:/Users/Rishin/Desktop/fleximart/Data/customers_raw.csv")
...
conn.commit()
print(" All essentia customers have been loaded..... ")


products = pd.read_csv("C:/Users/Rishin/Desktop/fleximart/Data/customers_raw.csv")
...
conn.commit()
print(" The products have been loaded successfully.... ")


sales = pd.read_csv("C:/Users/Rishin/Desktop/fleximart/Data/customers_raw.csv")
...
print("The sales with missing customer mapping have been removed :", before - after)
...
conn.commit()
print(" The required orders have been loaded")
...
conn.commit()
print("The order items have been loaded")

cursor.close()
conn.close()
print(".......... ETL Pipeline has been completed successfully ..........")
